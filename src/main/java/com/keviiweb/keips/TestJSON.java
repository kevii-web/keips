...
public class TestJSON {
    public static void main(String[] args) {
        // Serialize
        Student test = new Student("A0167086W","5519086W", "Ong Yu-He", "M", "1");
        ...
        Student test2 = new Student("A0177086A", "5629086A", "ABC AONG", "F", "2");
        ...
        Student test3 = new Student("A0187026K", "6667026K", "Thomas King", "M", "2");
