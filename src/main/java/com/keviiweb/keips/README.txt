...
**WARNING**
SET UP ENVRIONMENT
1. ensure the residents list is in the proper format (nusnet, magicnum, name, gender, semester)
...
printtojson - prints out the students as a json object and saves to output.json
